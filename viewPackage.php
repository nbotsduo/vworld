...
<html lang="en">
    ...
    <body>
      ...
      <form action=""method="POST">
        <div class="box">
            <span class="head">Package Editor: </span>
            <br>
            <div>*please make sure that there are no reservation for the package before delete!</div>
           <!--Database connection-->
            <?php
            ...
            <tbody>
              <tr>
                ...
                <td> <a href="editPackage.php?edited=1&id=<?php echo $row->pack_ID;?>">Edit</a> <a href="deletePackage.php?deleted=1&id=<?php echo $row->pack_ID;?>">Delete</a> </td> 
              </tr>
            </tbody>
            <?php
              }
