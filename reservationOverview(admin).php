...
<html lang="en">
    ...
    <body>
      ...
      <form action=""method="POST">
        <div class="box">
            <span class="head">Reservation Overview: </span>
            <br>
            <hr class="rule">
            <a class="btn btn-primary btn-lg float-left" href="registerUser.php"name="submit">Add Reservation</a>
            <br><br>
           <!--Database connection-->
            <?php
            ...
            <td> 
                <a href="detailReservation(admin).php?edited=1&id=<?php echo $row->reser_ID;?>">Detail</a> 
                <a href="editReservation(admin).php?edited=1&id=<?php echo $row->reser_ID;?>">Edit</a> 
                <a href="deleteReservation(admin).php?deleted=1&id=<?php echo $row->reser_ID;?>">Delete</a> 
            </td>          
            </tr>
            <?php 
                  }
