...
<html lang="en">
    ...
    <body>
        ...
        if(isset($_POST['submit'])){
            ...
            if($query){
                header('Refresh:0;summaryReservation(admin).php');
            }
        }
        ?>
        <form name="register2" method="POST">
            ...
            <div class="col-lg-2">
                                    ...
                                    <input type="text" id="quantity" name="quantity" class="form-control input-number" value="1" min="1" max="<?php echo $pPax;?>">
                                    <span class="input-group-btn">
            ...
            <div class="wrap-input100 validate-input" data-validate="Additional Request is optional">
                ...
                <input class="input100" type="text" name="Request" placeholder="Additional Request..."  >
